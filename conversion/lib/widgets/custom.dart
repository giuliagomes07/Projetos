        ...
        Container(
          decoration: const BoxDecoration(
            image: DecorationImage(
              ...
              image: AssetImage("imagens/icone-de-dinheiro.png",),
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                             ...
                             child: const Icon(Icons.monetization_on, size: 100.0, color: Colors.white),
                                  ),
                            Padding(
                              ...
                              child: RichText(
                                text: const TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      text: 'moedas',
                                      style: TextStyle(color: Colors.cyan, fontWeight: FontWeight.bold, fontSize: 20.0),
                                    ),
                                  ],
                                ),
                              ),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                const Divider(),
                                buildTextField("Dolar", "U\$", dollarController, _dollarChanged),
                                const Divider(),
